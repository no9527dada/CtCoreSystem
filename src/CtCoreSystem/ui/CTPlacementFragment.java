...
public class CTPlacementFragment extends PlacementFragment {
    ...
    //原版ui
    private PlacementFragment originFrag;
    ...
    public void build(Group parent){
        if (originFrag == null) {
            originFrag = ui.hudfrag.blockfrag;
        }

        Table toggler2 = Reflect.get(PlacementFragment.class, originFrag, "toggler");
        toggler2.visible(() -> false);//隐藏原版ui wtf因为Event.on注册了事件没法完全移除掉blockFrag 屑猫
