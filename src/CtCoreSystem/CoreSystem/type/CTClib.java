...
public class CTClib {
     ...
     * name
     */
   // public static final String modName=  mindustry.ctype.Content.minfo.mod.meta.name;
    public static final String modName = "ctcoresystem";

    public static String 资源描述(String name , String modname) {
        String key = "item."+modname+"-" + name + ".description";
        String value = Core.bundle.getOrNull(key);
        return value != null ? value : "";
    }
    public static String 液体描述(String name , String modname) {
        String key = "liquid."+modname+"-" + name + ".description";
        String value = Core.bundle.getOrNull(key);
        return value != null ? value : "";
    }
    public static String 方块描述(String name , String modname) {
        String key = "black."+modname+"-" + name + ".description";
        String value = Core.bundle.getOrNull(key);
        return value != null ? value : "";
    }
    /**
