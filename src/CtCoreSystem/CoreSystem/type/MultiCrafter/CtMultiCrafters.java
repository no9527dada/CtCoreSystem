...
public class CtMultiCrafters extends GenericCrafter {
    ...
    public CtMultiCrafters(String name, CreatorsRecipe[] recs) {
        super(name);
        this.recs = recs;
    ...
    public CtMultiCrafters(String name, int recLen){
    ...
    public void setBars() {
        ...
        if (powerBarO) {
            addBar("poweroutput", (CT3MultiCrafter.ChooseMultiCrafterBuild entity) ->
