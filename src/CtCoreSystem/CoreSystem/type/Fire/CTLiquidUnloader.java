...
//使用火种模组的代码  本人无法授权使用 找火种作者去
public class CTLiquidUnloader extends Block {

    private String centerRegion;

    public CTLiquidUnloader(String name){
        super(name);
        solid = false;
        underBullets = true;
        update = true;
        ...
        saveConfig = true;
        canOverdrive = false;
        buildType = CTLiquidUnloader.LiquidUnloaderBuild::new;
    ...
    public class LiquidUnloaderBuild extends Building {
        ...
        public void draw() {
            ...
            Draw.color();
            if (sortLiquid != null) {
                Draw.rect(sortLiquid.fullIcon, x, y - 1.5f,3,3);
            }
        }
        ...
        public void buildConfiguration(Table table) {
            ItemSelection.buildTable(CTLiquidUnloader.this, table, content.liquids(), () -> sortLiquid, this::configure);
        }
